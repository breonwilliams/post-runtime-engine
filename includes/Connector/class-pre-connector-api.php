...
class PCPTPages_Connector_API {
	...
	private static function get_field_name_hints() {
		return array(
			...
			'cpt_definition'       => array( 'slug', 'label_singular', 'label_plural', 'supports', 'public', 'has_archive', 'show_in_rest', 'show_in_menu', 'menu_position', 'menu_icon', 'taxonomies', 'capability_type', 'description', 'rewrite', 'hero_layout', 'hero_image_position', 'hero_image_aspect', 'hero_theme', 'hero_width', 'default_icon', 'archive_show_post_date', 'archive_show_post_author' ),
